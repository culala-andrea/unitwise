                ...
                CupertinoPicker(
                  ...
                  onSelectedItemChanged: (int index) {
                    setState(() {
                      switch (index) {
                        case 0:
                          convertname = "Kilometers per Hour";
                          converttype = "mphtokph";
                          unitype = "Miles per Hour";
                          _quantity.text = "";
                          result = "0.00";
                          break;
                        case 1:
                          convertname = "Miles per Hour";
                          converttype = "kphtomph";
                          unitype = "Kilometers per Hour";
                          _quantity.text = "";
                          result = "0.00";
                          break;
                        case 2:
                          convertname = "Meters per Second";
                          converttype = "fpsmps";
                          unitype = "Feet per Second";
                          _quantity.text = "";
                          result = "0.00";
                          break;
                        case 3:
                          convertname = "Feet per Second";
                          converttype = "mpsfps";
                          unitype = "Meters per Second";
                          _quantity.text = "";
                          result = "0.00";
                          break;
                      }
                  ...
                  child: CupertinoButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        if (converttype == "mphtokph") {
                          double res = num * 1.60934;
                          res = double.parse(res.toStringAsFixed(2));
                          result = res.toString();
                        } else if (converttype == "kphtomph") {
                          double res = num / 1.60934;
                          res = double.parse(res.toStringAsFixed(2));
                          result = res.toString();
                        } else if (converttype == "fpsmps") {
                          double res = num * 0.3048;
                          res = double.parse(res.toStringAsFixed(3));
                          result = res.toString();
                        } else if (converttype == "mpsfps") {
                          double res = num / 0.3048;
                          res = double.parse(res.toStringAsFixed(3));
                          result = res.toString();
                        }
